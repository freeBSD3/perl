...
system("xdotool mousemove 1064 110 click 1");
sleep 1;

system("xdotool mousemove 640 495 click 1");
sleep 7;

system("xdotool mousemove 634 563 click 1");
system("xdotool type 'dopaminerush\@icloud.com'");
system("xdotool mousemove 634 637 click 1");
system("xdotool type $password");
undef $password;
system("xdotool mousemove 634 750 click 1");
sleep 6;
